"""
Lab 2.1 - Tensorboard (Tutorial) - Logistic Regression
...
def compute_logistic_error_loss(ys_predictions_for_xs_data_features, ys_real_data_labels):
    ...
    logistic_error_loss_cost = -tensorflow.reduce_mean(
        (ys_real_data_labels * tensorflow.math.log(ys_predictions_for_xs_data_features)) +
        (1 - ys_real_data_labels) * (tensorflow.math.log(1 - ys_predictions_for_xs_data_features)))
