...
# The function to compute the Cost of the Logistic Loss,
...
def compute_logistic_loss(ys_predictions_for_xs_data_features, ys_real_data_labels):
    ...
    # Compute the Cost of Logistic Loss
    logistic_loss_cost = -tensorflow.reduce_mean(
        (tensorflow_constant_ys_predictions_for_xs_data_features *
    ...
    # Return the Cost of the Logistic Loss
    return logistic_loss_cost
...
def compute_gradient(xs_data_features_to_predict, ys_real_data_labels):
    ...
    with tensorflow.GradientTape() as tape:
        ...
        loss_cost_value = compute_logistic_loss(neural_network_predicted_ys, ys_real_data_labels)
...
def execute_artificial_neural_network():
    ...
    for current_epoch in range(num_epochs):
        ...
        # Compute the Cost of the Logistic Loss, between the predicted ys (Labels) of the Data of the Genes,
        # through the Artificial Neural Network (ANN) and the real ys (Labels) of the Data of the Genes
        logistic_loss = compute_logistic_loss(ys_labels_predicted_for_data, ys_data_labels)
